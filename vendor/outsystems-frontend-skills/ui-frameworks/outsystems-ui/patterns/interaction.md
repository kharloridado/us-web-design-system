...
For format conventions and reference entity values, see [blocks-index.md](../blocks-index.md).
...
| `Carousel.ItemsPerSlide` | Integer | Items shown per slide (`"1"`, `"3"`). |
| `Carousel.OptionalConfigs` | Record | `{ AutoPlay: Boolean, Loop: Boolean, … }`. |
